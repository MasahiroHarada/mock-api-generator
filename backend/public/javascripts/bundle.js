...
var MockFormComponent = require('./MockForm.vue');
var LoadingComponent = require('./Loading.vue');
var CompleteComponent = require('./Complete.vue');
...
exports.default = {
  ...
  methods: {
    ...
    onCreate: function onCreate(responseData) {
...
__vue__options__.render = function(){with(this){return _h('div',[(isShowForm)?_h('mock-form',{attrs:{"showLoading":showLoading.bind(this),"onError":backToHome.bind(this),"onCreate":onCreate.bind(this)}}):_e()," ",(isShowLoading)?_h('loading'):_e()," ",(isShowComplete)?_h('complete',{attrs:{"url":url,"apiKey":apiKey,"onBackToHomeClick":backToHome.bind(this)}}):_e()])}}
...
exports.default = {
  ...
  props: ['showLoading', 'onCreate', 'onError'],
  methods: {
    ...
    submitForm: function submitForm() {
      ...
      this.$http.post(url, req).then(function (response) {
        if (!response.ok) {
          throw Error();
        }
        _this.onCreate(response.body.data);
        _this.clearForm();
      }).catch(function (error) {
        _this.onError();
        _this.error = 'Sorry, something\'s not quite right';
      });
    },
...
},{"./components/App.vue":1,"particles.js":6,"vue":10,"vue-resource":9}],6:[function(require,module,exports){
/* -----------------------------------------------
